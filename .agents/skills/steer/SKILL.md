...
- **The sprint plan docs** — *strategy*: `docs/architecture_cleanup.md` (`clean`, the primary
  ...
  designs, and open forks. Slow-changing. Answers *why* and *in what order*. AGENTS.md's
...
3. **Rank**, in order: (a) primary sprint before secondary (AGENTS.md "Current focus");
...
2. **Do the work** — normal implementation, obeying `AGENTS.md` (diagnosis-before-patching
