...
with a terrain block. This is Codex's primary visual-feedback loop for
terrain work — Codex can `Read` the PNGs directly as images to inspect
...
**Chrome tracing (Codex-driven, autonomous):** Codex runs this when
...
name, and prints a top-N table Codex reads to identify hot spots.
