...
| CLOUD-2 | Scalable targets and temporal reconstruction: viewport-relative/interleaved march, history rejection/clamp/upscale, screenshot mode and quality ladder | wip | L | first slice captured 2026-07-21: 1280×720 target, 40.66 MiB persistent allocation, quality probes; viewport-relative sizing, sparse topology and neighborhood clamp/moments remain | cloud §3.3 · §4 |
| CLOUD-3 | Multi-scale density and range: typed vertical profiles, true 3-D base/detail noise, anti-tiling, empty-space skip and near-to-horizon LOD | wip | L | first slice captured 2026-07-21: 64³ true 3-D basis, typed profiles/base/top/anvil, macro threshold, boundary erosion, 50 km march; hierarchy and mid-distance LOD remain | cloud §3.2–§3.3 · INC-0007 |
