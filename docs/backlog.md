...
| MIRA-1 | **Airless diffusion patch proof:** Rust/Burn 0.21 backend-generic denoiser + DDPM/DDIM contract; deterministic labelled crater/ejecta/gardening corpus; physical-scale Laplacian S0–S3; SafeTensors + canonical tensor hash; shared-noise overlapping-window sampler and repeat/contact-sheet evidence landed. Remaining: checksum/licence-pinned SLDEM2015 + aligned Kaguya subsets and geographic holdouts, EMA/resume, S0–S3 campaign quality, spectral/slope/SFD + VRAM evidence | wip | L–XL research | MIRA-0 schema | mira_airless_mvp.md §6, §8 · ADR-0010 |
