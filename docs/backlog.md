...
| CLOUD-3 | Multi-scale density and range: typed vertical profiles, true 3-D base/detail noise, anti-tiling, empty-space skip and near-to-horizon LOD | done | L | completed 2026-07-21: 64³ multi-domain density, typed/height-warped profiles, mid-scale cauliflower, 3-level conservative empty-space hierarchy, continuous weather attributes, near→horizon shape/detail/step LOD; five-view recapture complete. A denser hierarchy volume was measured unnecessary at the budget; transport polish moves to CLOUD-4 | cloud §3.2–§3.3 · INC-0007 · cloud_baseline.md |
