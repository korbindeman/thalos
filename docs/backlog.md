...
| CLOUD-3 | Multi-scale density and range: typed vertical profiles, true 3-D base/detail noise, anti-tiling, cadence-safe range LOD | done | L | corrected 2026-07-21 after matched A/B: heuristic hierarchy leaps caused posterized height strata and were deleted (ADR-0008); proven typed 3-D density restored, fine erosion fades 10–22 km, 21.6 km macro modulation is reused per ray. Five views clean; 1440p High sunset 2.471 ms mean / 2.476 p95 | cloud §3.2–§3.3 · INC-0007 · INC-0008 · cloud_baseline.md |
