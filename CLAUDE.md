...
- **Neural terrain** — hierarchical diffusion, fine-tuned offline behind the
  terrain-package boundary; Thalos/earth-like first. Plan: `ntr §N`.
...
- Primary machine is a Mac; FPS and battery/power draw are first-class.
