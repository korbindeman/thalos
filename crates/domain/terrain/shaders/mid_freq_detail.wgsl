...
// `crates/domain/terrain/src/cubemap.rs` — if either side moves, both
...
// `crates/domain/terrain/src/noise.rs`. If you edit any of:
...
// ---------------------------------------------------------------------------
//
// Mirrors `face_uv_to_dir` in `crates/domain/terrain/src/cubemap.rs`. The
...
// `crates/domain/terrain/src/pipeline.rs` — both render paths must project the
...
fn main(@builtin(global_invocation_id) gid: vec3<u32>) {
    ...
    // detail cascade in `crates/domain/terrain/src/pipeline.rs`. The face_uv
