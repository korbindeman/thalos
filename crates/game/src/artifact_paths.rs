...
//!
//! Curated scene images live in `tools/screenshots/`. Machine-readable logs
//! belong under `tools/diagnostics/`, while agents put ad-hoc image iterations
//! in `tools/agent_scratch/`. Keeping the path policy here prevents each
...
const DIAGNOSTICS_DIR: &str = "tools/diagnostics";
