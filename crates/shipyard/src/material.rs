...
//! is*. This shim re-exports the type so the construction model
//! (`crate::appearance`) and the render/editor consumers keep compiling
//! unchanged while the material-*application* split is deferred to the
//! follow-up.
//!
...
//! material application out of the editor (now `thalos_game::shipyard_editor`),
//! then flips this to the clean `body_render → shipyard` direction and drops
//! this dependency.
