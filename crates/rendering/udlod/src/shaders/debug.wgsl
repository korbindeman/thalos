#define_import_path thalos_udlod::debug

#import thalos_udlod::types::{Coordinate, AtlasTile, Blend}
#import thalos_udlod::bindings::{config, tile_tree, view_config, geometry_tiles, attachments, origins, terrain_model_approximation}
#import thalos_udlod::functions::{inverse_mix, compute_coordinate, lookup_best, approximate_view_distance, compute_blend, tree_lod, inside_square, tile_coordinate, coordinate_from_local_position, compute_subdivision_coordinate}
