...
//!   `artifacts/visual/latest/object_preview/` and exits. No window, off-screen render target — so it
...
//! the game runs (`thalos_runtime::rendering::sun_shadow`), trimmed to one cascade.
...
// ---------------------------------------------------------------------------
//
// A trimmed copy of `thalos_runtime::rendering::sun_shadow`: an orthographic camera
