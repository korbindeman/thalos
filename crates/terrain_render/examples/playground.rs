//! Stage 1 sanity check for M3: drives `thalos_udlod` end-to-end inside the
...
//!
//! ```bash
//! cargo run -p thalos_terrain_render --example playground
//! ```
//!
...
use thalos_terrain_render::{PlaygroundMaterial, SyntheticTileProvider, ThalosTerrainPlugin};
