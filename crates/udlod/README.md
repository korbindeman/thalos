...
This crate is a Thalos-specific fork of
[`bevy_terrain`](https://github.com/kurtkuehnert/bevy_terrain) by Kurt
Kühnert (MIT OR Apache-2.0). It diverges from upstream as the renderer
is shaped to fit Thalos's needs. For general-purpose Bevy terrain
rendering, use the upstream crate instead.

The original README is preserved verbatim below for context and
attribution. Project links, badges, and Discord pointers refer to
Kurt's original project, not this fork.
