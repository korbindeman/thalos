#define_import_path thalos_udlod::fragment

#import thalos_udlod::types::{Blend, AtlasTile, Coordinate}
#import thalos_udlod::bindings::{config, view_config, geometry_tiles}
#import thalos_udlod::functions::{compute_blend, lookup_tile}
#import thalos_udlod::attachments::{sample_normal, sample_color}
#import thalos_udlod::debug::{show_data_lod, show_geometry_lod, show_tile_tree, show_pixels}
