#define_import_path thalos_udlod::vertex

#import thalos_udlod::types::{Blend, AtlasTile, Coordinate}
#import thalos_udlod::bindings::{config, view_config, geometry_tiles, terrain_model_approximation}
#import thalos_udlod::functions::{lookup_tile, compute_tile_uv, compute_local_position, compute_relative_position, compute_morph, compute_blend, normal_local_to_world, position_local_to_world}
#import thalos_udlod::attachments::{sample_height}
