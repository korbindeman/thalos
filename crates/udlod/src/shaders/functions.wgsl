#define_import_path thalos_udlod::functions

#import thalos_udlod::bindings::{mesh, config, origins, view_config, geometry_tiles, tile_tree, terrain_model_approximation}
#import thalos_udlod::types::{TileCoordinate, TileTree, TileTreeEntry, AtlasTile, Blend, BestLookup, Coordinate, Morph}
