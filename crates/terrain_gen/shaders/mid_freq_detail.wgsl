...
// `crates/terrain_gen/src/cubemap.rs` — if either side moves, both
...
// `crates/terrain_gen/src/noise.rs`. If you edit any of:
...
// `value_noise_3d_derivative` in `terrain_gen/src/noise.rs`.
...
// ---------------------------------------------------------------------------
//
// Mirrors `face_uv_to_dir` in `crates/terrain_gen/src/cubemap.rs`. The
