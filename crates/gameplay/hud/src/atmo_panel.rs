...
pub fn update(
        ...
        && let Ok(mut text) = text_q.single_mut()
    {
        ...
        let tas = crate::format::speed(flight.airspeed_ms, system);
        let q = crate::format::dynamic_pressure(flight.dynamic_pressure_pa, system);
