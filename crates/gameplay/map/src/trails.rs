...
pub fn draw_orbits(
    ...
    player: Option<Res<thalos_game_state::flight::PlayerControllerState>>,
    ...
    let focus_body_id = match focus.target {
        ...
        CameraFocusTarget::Ship => Some(thalos_game_state::camera::find_reference_body(
