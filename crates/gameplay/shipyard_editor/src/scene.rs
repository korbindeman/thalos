...
//! [`thalos_game_state::coords::EDITOR_LAYER`] with its own clear colour, key/fill
...
fn setup_editor_scene(
    ...
    commands.spawn((
        ...
        // `thalos_body_shading::SHADOW_CASCADE_COUNT`.
        CascadeShadowConfigBuilder {
            num_cascades: thalos_body_shading::SHADOW_CASCADE_COUNT,
            ..default()
        }
        .build(),
        layer.clone(),
