...
//!   `tools/ui_preview/kitchen_sink.png`, then exits — agents iterate on the
...
const OUT_PATH: &str = "tools/ui_preview/kitchen_sink.png";
...
fn main() {
    std::fs::create_dir_all("tools/ui_preview").ok();
